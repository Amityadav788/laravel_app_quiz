            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <label for="select_subject" class="col-md-4 col-form-label text-md-end">{{ __('Select Subject') }}</label>
                           
                            <div class="col-md-6">
                                <?php $subjects = App\Models\Subject::all(); ?>
                           <select type="text" class="form-control" name="subject_id" id="subject_id" placeholder="Select subject" value="">
